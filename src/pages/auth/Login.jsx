  ...
  return (
    <React.Fragment>
        <div className=' px-3 py-3'>
            <p className=' font-semibold text-xl  text-center'>Sign into <span className=' bg-clip-text bg-gradient-to-tr from-green-500 to-purple-600 text-transparent font-semibold'>KRYPT</span></p>
